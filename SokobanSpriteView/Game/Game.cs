...
class Game
{
    ...
    public void Update()
    {
        ...
        DrawTile(textures.player, Vector2.Lerp(cur_state.PlayerPlayerLinearMovement.from.ToVector2(), cur_state.PlayerPlayerLinearMovement.to.ToVector2(), turn_progress));
